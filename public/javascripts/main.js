; (function () {
	...
	window.onload = function () {
		//AtCoder chart
		var labels = ["2019/08/10", "2019/09/1", "2019/10/27", "2019/11/16", "2019/11/24", "2020/03/22", "2020/03/28", "2020/04/04", "2020/04/26",
			"2020/05/02", "2020/05/03", "2020/05/10", "2020/05/17"];

		var rating = [5, 15, 33, 50, 50, 67, 77, 76, 117, 119, 116, 126, 132];

		var pointcolor = generatePointColor(rating, "rgba(255, 0, 0, 0.9)", "rgba(128, 128, 128, 1.0)");
	...
	//最大値のプロットの色だけ変更
	function generatePointColor(points, topcolor, defaultcolor) {
		var color = [];
